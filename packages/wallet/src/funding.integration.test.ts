  ...
  it("settles a deposit and keeps concurrent credit retries idempotent", async () => {
    ...
    try {
      ...
      await client.pool.query(
        ...
        [externalId, assetId, `wallet-external:${externalId}`, pendingDepositId, userId, `wallet-pending-deposit:${pendingDepositId}`, availableId, userId, `wallet-available:${availableId}`, lockedId, userId, `wallet-locked:${lockedId}`, pendingWithdrawalId, userId, `wallet-pending-withdrawal:${pendingWithdrawalId}`]
      );
